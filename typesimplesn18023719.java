/*Ecrire un programme principal qui réalise la saisie et l’affichage de plusieurs variables de types différents :
...
un caractère,
un booléen
 [main, type int, float, String, caractère, booléen, Date et affichage de chacun des types]
